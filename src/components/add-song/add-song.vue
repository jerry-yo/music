  ...
  <transition name="slide">
    <div class="add-song" v-show="showFlag" @click.stop>
      ...
      <div class="shortcut" v-show="!query">
        ...
        <div class="list-wrapper">
          <Scroll class="list-scroll" ref="songList" v-if="currentIndex === 0" :data="playHistory">
           ...
           <Scroll class="list-scroll" v-if="currentIndex === 1" ref="searchList" :refreshDelay="refreshDelay">
            <div class="list-inner">
      ...
      <div class="search-result" v-show="query">
        <Suggest :query="query" :showSinger="showSinger" @select="seleSuggest" @listScroll="blurInput"></Suggest>
      </div>
      <TopTip ref="topTip">
        <div class="tip-title">
          <i class="icon-ok"></i>
